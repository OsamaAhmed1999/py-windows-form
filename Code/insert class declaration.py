...
def Syntax_Analyzer():
    ...
    def C_body(C_name):
        global i
        if(set[i][0]== "AM" or set[i][0] == "static" or set[i][0] == "const" or set[i][0] == "virtual" or set[i][0] == "DT" or set[i][0] == "ID" or set[i][0] == "}"):
            ...
            if(set[i][0] == "AM"):
                ...
                if(set[i][0]== ":"):
                    ...
                    if(C_TM(am, C_name)):
                        if(C_body(C_name)):
                            return True
            elif(set[i][0] == "static" or set[i][0] == "const" or set[i][0] == "virtual" or set[i][0] == "DT" or set[i][0] == "ID" ):
                am = "private"
                if(C_TM(am, C_name)):
                    if(C_body(C_name)):
                        return True
    ...
    def X2(T, am, tm, C_name):
        ...
        if(set[i][0] == "ID" or  set[i][0] == "[" ):
            ...
            if(set[i][0]== "["):
                ...
                N = set[i][1]
                i+= 1
                if(Class2(N, T, am, tm, C_name)):
                    return True
        return False

    def Class2(N, T, am, tm, C_name):
        global i
        if(set[i][0]== "AOP" or set[i][0] == "[" or set[i][0] == "," or  set[i][0] == "(" or set[i][0] == ";"):
